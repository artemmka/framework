...
class Cube extends Surface {
    constructor(edge: number = 5, center: Point = new Point()) {
        super([
            ...
            new Polygon([0, 1, 2, 3], '#00ffff'),
            new Polygon([0, 4, 5, 1], '#00ffff'),
            new Polygon([0, 3, 7, 4], '#00ffff'),
            new Polygon([6, 5, 4, 7], '#00ffff'),
            new Polygon([6, 7, 3, 2], '#00ffff'),
            new Polygon([6, 2, 1, 5], '#00ffff')
        ],
            center
        );
    }
